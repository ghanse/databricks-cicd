...
The 'cicd_example' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/cicd_example/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] cicd_example_etl` to your workspace.
